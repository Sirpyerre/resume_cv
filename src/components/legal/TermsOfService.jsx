...
export default function TermsOfService({ language = "es" }) {
            ...
            <div className="container mx-auto max-w-4xl px-4 py-16">
                ...
                {t.sections.map((section, index) => (
                    <section key={index} className="mb-8">
                        ...
                        {section.services && (
                            <p className="text-tinta-suave mb-2 font-semibold">{section.services}</p>
                        )}

                        {section.process && (
                            <p className="text-tinta-suave mb-2 font-semibold">{section.process}</p>
                        )}

                        {section.restrictions && (
                            <p className="text-tinta-suave mb-2 font-semibold">{section.restrictions}</p>
                        )}

                        {section.limitations && (
                            <p className="text-tinta-suave mb-2 font-semibold">{section.limitations}</p>
                        )}
                        ...
                        {section.notification && (
                            <p className="text-tinta-suave mb-4 italic">{section.notification}</p>
                        )}

                        {section.email && (
                            <>
                                <p className="text-verde mb-2">{section.email}</p>
