        ...
        <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6 pt-16 pb-20">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex justify-center space-x-4 sm:space-x-6 mb-8 sm:mb-12">
                    <a href="https://www.linkedin.com/in/sirpyerre/" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 border border-gray-600 rounded-full hover:border-green-400 hover:text-green-400 transition-colors">
